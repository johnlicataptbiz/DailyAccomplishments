...
Run this from the repo root to verify all components are properly installed.
"""
...
def main():
    ...
    try:
        ...
        if "tracking" in config:
            print("✓ Config has tracking section")
            checks_passed += 1
        else:
            print("✗ Config missing tracking section")

        total_checks += 1
        if "analytics" in config:
            print("✓ Config has analytics section")
            checks_passed += 1
        else:
            print("✗ Config missing analytics section")

        total_checks += 1
        if "notifications" in config:
            print("✓ Config has notifications section")
            checks_passed += 1
        else:
            print("✗ Config missing notifications section")
